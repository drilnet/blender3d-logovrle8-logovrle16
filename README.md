...
Изображения логотипа разных размеров (плюс анимационный логотип разных размеров) и сам **blend**-файл [здесь](https://github.com/drilnet/blender3d-logovrle8-logovrle16/tree/master/LogoVRLE8%2C%20ver.%200%207)
